...
import { AuthUser, AuthenticatedRequest, MetaInterface } from './global.interface';
...
export abstract class BaseController<T extends Document, S extends BaseService<T>> {
  ...
  protected sendSuccess<U>(res: Response, data: U, message: string = 'Success', statusCode: number = 200,  meta?: MetaInterface): void {
